...
classdef daobanKST < handle
    ...
    methods
        ...
        % Constructor method:
        function this = daobanKST(robot_ip,robotType,h_flange, varargin)
            if nargin==4
                temp=varargin{1};
        ...
        function eef_f = moveWaitForDTWhenInterrupted_lhc( this ,...
                Pos, VEL,joints_indices,max_torque,min_torque, w)
            eef_f = moveWaitForDTWhenInterrupted_lhc( this.t_Kuka ,...
                Pos, VEL,joints_indices,max_torque,min_torque, w);
        end
