...
int main(int argc, _TCHAR* argv[])
{
	...
	while (time < 2)
	{
		...
		// myHand.Send_Frame_SetAngle(700, 700, 700, 700, 700, 0);
		myHand.Send_Frame_SetAngle(1000, 1000, 1000, 1000, 1000, 0);
		...
		//myHand.Send_Frame_SetAngle(500, 500, 500, 500, 600, 40);
